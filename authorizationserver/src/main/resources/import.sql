...
insert into Menu (menuNumber, displayName, interiorName, iconKey, addressValue, displayYesorno, anonymYesorno, detailValue) values (23, 'Role 관리', '시스템 Role', 'film', '/system/roles-view', true, false, 'authorizationserver');
insert into Menu (menuNumber, displayName, interiorName, iconKey, addressValue, displayYesorno, anonymYesorno, detailValue) values (31, '사용자 Role', '권한 사용자', 'user', '/authority/users-view', true, false, 'authorizationserver');
insert into Menu (menuNumber, displayName, interiorName, iconKey, addressValue, displayYesorno, anonymYesorno, detailValue) values (32, '메뉴 Role', '권한 메뉴', 'list-alt', '/authority/menus-view', true, false, 'authorizationserver');
