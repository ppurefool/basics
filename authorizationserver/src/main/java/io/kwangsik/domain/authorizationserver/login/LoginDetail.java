...
public class LoginDetail {
    ...
    public LoginDetail(final int number, final String type, final Integer error, final String address,
        ...
        if (null == error) errorName = null;
        else if (-1 == error) errorName = "E-mail 불일치";
